...
const IconDeviceUnknownFilled = createReactComponent("filled", "device-unknown-filled", "DeviceUnknownFilled", __iconNode);

export { __iconNode, IconDeviceUnknownFilled as default };
