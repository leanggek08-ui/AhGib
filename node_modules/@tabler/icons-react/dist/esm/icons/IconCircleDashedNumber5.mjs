...
const IconCircleDashedNumber5 = createReactComponent("outline", "circle-dashed-number-5", "CircleDashedNumber5", __iconNode);

export { __iconNode, IconCircleDashedNumber5 as default };
