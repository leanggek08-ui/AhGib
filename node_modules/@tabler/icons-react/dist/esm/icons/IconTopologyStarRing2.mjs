...
const IconTopologyStarRing2 = createReactComponent("outline", "topology-star-ring-2", "TopologyStarRing2", __iconNode);

export { __iconNode, IconTopologyStarRing2 as default };
