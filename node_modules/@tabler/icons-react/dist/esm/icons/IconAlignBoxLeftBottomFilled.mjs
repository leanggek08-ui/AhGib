...
const IconAlignBoxLeftBottomFilled = createReactComponent("filled", "align-box-left-bottom-filled", "AlignBoxLeftBottomFilled", __iconNode);

export { __iconNode, IconAlignBoxLeftBottomFilled as default };
