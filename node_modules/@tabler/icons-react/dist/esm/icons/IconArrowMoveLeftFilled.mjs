...
const IconArrowMoveLeftFilled = createReactComponent("filled", "arrow-move-left-filled", "ArrowMoveLeftFilled", __iconNode);

export { __iconNode, IconArrowMoveLeftFilled as default };
