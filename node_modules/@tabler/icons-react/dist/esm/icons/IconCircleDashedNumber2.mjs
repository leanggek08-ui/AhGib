...
const IconCircleDashedNumber2 = createReactComponent("outline", "circle-dashed-number-2", "CircleDashedNumber2", __iconNode);

export { __iconNode, IconCircleDashedNumber2 as default };
