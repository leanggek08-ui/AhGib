...
const IconCircleDashedNumber3 = createReactComponent("outline", "circle-dashed-number-3", "CircleDashedNumber3", __iconNode);

export { __iconNode, IconCircleDashedNumber3 as default };
