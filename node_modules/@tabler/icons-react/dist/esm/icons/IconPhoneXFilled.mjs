...
const IconPhoneXFilled = createReactComponent("filled", "phone-x-filled", "PhoneXFilled", __iconNode);

export { __iconNode, IconPhoneXFilled as default };
//# sourceMappingURL=IconPhoneXFilled.mjs.map
