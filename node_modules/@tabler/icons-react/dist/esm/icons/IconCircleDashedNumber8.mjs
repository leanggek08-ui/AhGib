...
const IconCircleDashedNumber8 = createReactComponent("outline", "circle-dashed-number-8", "CircleDashedNumber8", __iconNode);

export { __iconNode, IconCircleDashedNumber8 as default };
