...
const IconMicroscopeFilled = createReactComponent("filled", "microscope-filled", "MicroscopeFilled", __iconNode);

export { __iconNode, IconMicroscopeFilled as default };
//# sourceMappingURL=IconMicroscopeFilled.mjs.map
