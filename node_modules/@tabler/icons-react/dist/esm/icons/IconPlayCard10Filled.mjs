...
const IconPlayCard10Filled = createReactComponent("filled", "play-card-10-filled", "PlayCard10Filled", __iconNode);

export { __iconNode, IconPlayCard10Filled as default };
