...
const IconAlignBoxBottomCenterFilled = createReactComponent("filled", "align-box-bottom-center-filled", "AlignBoxBottomCenterFilled", __iconNode);

export { __iconNode, IconAlignBoxBottomCenterFilled as default };
