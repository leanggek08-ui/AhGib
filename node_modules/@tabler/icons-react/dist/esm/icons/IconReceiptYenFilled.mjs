...
const IconReceiptYenFilled = createReactComponent("filled", "receipt-yen-filled", "ReceiptYenFilled", __iconNode);

export { __iconNode, IconReceiptYenFilled as default };
//# sourceMappingURL=IconReceiptYenFilled.mjs.map
