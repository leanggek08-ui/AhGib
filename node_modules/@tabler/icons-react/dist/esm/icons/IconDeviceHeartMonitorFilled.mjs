...
const IconDeviceHeartMonitorFilled = createReactComponent("filled", "device-heart-monitor-filled", "DeviceHeartMonitorFilled", __iconNode);

export { __iconNode, IconDeviceHeartMonitorFilled as default };
