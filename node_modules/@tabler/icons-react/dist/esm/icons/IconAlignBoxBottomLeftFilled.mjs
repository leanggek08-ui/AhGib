...
const IconAlignBoxBottomLeftFilled = createReactComponent("filled", "align-box-bottom-left-filled", "AlignBoxBottomLeftFilled", __iconNode);

export { __iconNode, IconAlignBoxBottomLeftFilled as default };
