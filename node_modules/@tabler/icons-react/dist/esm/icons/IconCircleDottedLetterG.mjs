...
const IconCircleDottedLetterG = createReactComponent("outline", "circle-dotted-letter-g", "CircleDottedLetterG", __iconNode);

export { __iconNode, IconCircleDottedLetterG as default };
