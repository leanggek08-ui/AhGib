...
const IconHexagonLetterNFilled = createReactComponent("filled", "hexagon-letter-n-filled", "HexagonLetterNFilled", __iconNode);

export { __iconNode, IconHexagonLetterNFilled as default };
