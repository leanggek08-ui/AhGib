...
const IconChartDots2Filled = createReactComponent("filled", "chart-dots-2-filled", "ChartDots2Filled", __iconNode);

export { __iconNode, IconChartDots2Filled as default };
