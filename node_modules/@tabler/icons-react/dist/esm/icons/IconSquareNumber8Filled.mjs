...
const IconSquareNumber8Filled = createReactComponent("filled", "square-number-8-filled", "SquareNumber8Filled", __iconNode);

export { __iconNode, IconSquareNumber8Filled as default };
