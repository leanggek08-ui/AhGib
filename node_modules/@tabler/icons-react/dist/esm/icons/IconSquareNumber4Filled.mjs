...
const IconSquareNumber4Filled = createReactComponent("filled", "square-number-4-filled", "SquareNumber4Filled", __iconNode);

export { __iconNode, IconSquareNumber4Filled as default };
