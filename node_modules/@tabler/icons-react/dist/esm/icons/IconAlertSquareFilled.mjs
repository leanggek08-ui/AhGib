...
const IconAlertSquareFilled = createReactComponent("filled", "alert-square-filled", "AlertSquareFilled", __iconNode);

export { __iconNode, IconAlertSquareFilled as default };
