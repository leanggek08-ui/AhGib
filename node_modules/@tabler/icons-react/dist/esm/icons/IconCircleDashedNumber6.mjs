...
const IconCircleDashedNumber6 = createReactComponent("outline", "circle-dashed-number-6", "CircleDashedNumber6", __iconNode);

export { __iconNode, IconCircleDashedNumber6 as default };
