...
const IconCircleDashedNumber9 = createReactComponent("outline", "circle-dashed-number-9", "CircleDashedNumber9", __iconNode);

export { __iconNode, IconCircleDashedNumber9 as default };
