...
const IconAlignBoxLeftTopFilled = createReactComponent("filled", "align-box-left-top-filled", "AlignBoxLeftTopFilled", __iconNode);

export { __iconNode, IconAlignBoxLeftTopFilled as default };
