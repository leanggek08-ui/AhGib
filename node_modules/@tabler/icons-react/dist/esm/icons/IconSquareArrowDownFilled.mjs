...
const IconSquareArrowDownFilled = createReactComponent("filled", "square-arrow-down-filled", "SquareArrowDownFilled", __iconNode);

export { __iconNode, IconSquareArrowDownFilled as default };
