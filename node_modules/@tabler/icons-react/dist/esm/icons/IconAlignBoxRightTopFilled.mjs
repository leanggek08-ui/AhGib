...
const IconAlignBoxRightTopFilled = createReactComponent("filled", "align-box-right-top-filled", "AlignBoxRightTopFilled", __iconNode);

export { __iconNode, IconAlignBoxRightTopFilled as default };
