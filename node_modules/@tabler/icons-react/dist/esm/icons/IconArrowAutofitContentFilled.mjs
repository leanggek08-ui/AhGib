...
const IconArrowAutofitContentFilled = createReactComponent("filled", "arrow-autofit-content-filled", "ArrowAutofitContentFilled", __iconNode);

export { __iconNode, IconArrowAutofitContentFilled as default };
