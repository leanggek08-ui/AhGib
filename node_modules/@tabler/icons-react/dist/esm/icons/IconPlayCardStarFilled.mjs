...
const IconPlayCardStarFilled = createReactComponent("filled", "play-card-star-filled", "PlayCardStarFilled", __iconNode);

export { __iconNode, IconPlayCardStarFilled as default };
