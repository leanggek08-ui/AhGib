...
const IconCircleDashedNumber4 = createReactComponent("outline", "circle-dashed-number-4", "CircleDashedNumber4", __iconNode);

export { __iconNode, IconCircleDashedNumber4 as default };
