...
const IconCircleDashedPercentage = createReactComponent("outline", "circle-dashed-percentage", "CircleDashedPercentage", __iconNode);

export { __iconNode, IconCircleDashedPercentage as default };
