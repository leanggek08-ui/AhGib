...
const IconCircleDashedNumber1 = createReactComponent("outline", "circle-dashed-number-1", "CircleDashedNumber1", __iconNode);

export { __iconNode, IconCircleDashedNumber1 as default };
