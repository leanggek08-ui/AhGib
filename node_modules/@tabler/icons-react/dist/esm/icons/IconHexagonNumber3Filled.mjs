...
const IconHexagonNumber3Filled = createReactComponent("filled", "hexagon-number-3-filled", "HexagonNumber3Filled", __iconNode);

export { __iconNode, IconHexagonNumber3Filled as default };
