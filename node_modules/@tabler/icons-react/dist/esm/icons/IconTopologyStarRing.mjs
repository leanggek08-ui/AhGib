...
const IconTopologyStarRing = createReactComponent("outline", "topology-star-ring", "TopologyStarRing", __iconNode);

export { __iconNode, IconTopologyStarRing as default };
