...
const IconSquareRoundedNumber8Filled = createReactComponent("filled", "square-rounded-number-8-filled", "SquareRoundedNumber8Filled", __iconNode);

export { __iconNode, IconSquareRoundedNumber8Filled as default };
