...
const IconAlignBoxRightBottomFilled = createReactComponent("filled", "align-box-right-bottom-filled", "AlignBoxRightBottomFilled", __iconNode);

export { __iconNode, IconAlignBoxRightBottomFilled as default };
