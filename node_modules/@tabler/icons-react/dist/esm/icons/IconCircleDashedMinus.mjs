...
const IconCircleDashedMinus = createReactComponent("outline", "circle-dashed-minus", "CircleDashedMinus", __iconNode);

export { __iconNode, IconCircleDashedMinus as default };
