...
const IconSquareNumber0Filled = createReactComponent("filled", "square-number-0-filled", "SquareNumber0Filled", __iconNode);

export { __iconNode, IconSquareNumber0Filled as default };
