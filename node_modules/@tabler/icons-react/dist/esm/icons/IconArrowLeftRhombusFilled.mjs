...
const IconArrowLeftRhombusFilled = createReactComponent("filled", "arrow-left-rhombus-filled", "ArrowLeftRhombusFilled", __iconNode);

export { __iconNode, IconArrowLeftRhombusFilled as default };
