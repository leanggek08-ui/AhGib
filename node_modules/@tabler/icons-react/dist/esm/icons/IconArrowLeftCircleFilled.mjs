...
const IconArrowLeftCircleFilled = createReactComponent("filled", "arrow-left-circle-filled", "ArrowLeftCircleFilled", __iconNode);

export { __iconNode, IconArrowLeftCircleFilled as default };
