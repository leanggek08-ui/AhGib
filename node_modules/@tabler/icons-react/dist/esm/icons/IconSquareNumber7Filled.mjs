...
const IconSquareNumber7Filled = createReactComponent("filled", "square-number-7-filled", "SquareNumber7Filled", __iconNode);

export { __iconNode, IconSquareNumber7Filled as default };
