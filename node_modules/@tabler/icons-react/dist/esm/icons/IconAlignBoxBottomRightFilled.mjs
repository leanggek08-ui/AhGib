...
const IconAlignBoxBottomRightFilled = createReactComponent("filled", "align-box-bottom-right-filled", "AlignBoxBottomRightFilled", __iconNode);

export { __iconNode, IconAlignBoxBottomRightFilled as default };
