...
const IconBrandAdobePhotoshop = createReactComponent("outline", "brand-adobe-photoshop", "BrandAdobePhotoshop", __iconNode);

export { __iconNode, IconBrandAdobePhotoshop as default };
