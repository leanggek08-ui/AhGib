...
const IconReceiptYuanFilled = createReactComponent("filled", "receipt-yuan-filled", "ReceiptYuanFilled", __iconNode);

export { __iconNode, IconReceiptYuanFilled as default };
//# sourceMappingURL=IconReceiptYuanFilled.mjs.map
