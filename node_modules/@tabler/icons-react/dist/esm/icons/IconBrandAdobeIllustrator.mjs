...
const IconBrandAdobeIllustrator = createReactComponent("outline", "brand-adobe-illustrator", "BrandAdobeIllustrator", __iconNode);

export { __iconNode, IconBrandAdobeIllustrator as default };
