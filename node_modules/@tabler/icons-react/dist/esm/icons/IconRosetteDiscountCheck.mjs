...
const IconRosetteDiscountCheck = createReactComponent("outline", "rosette-discount-check", "RosetteDiscountCheck", __iconNode);

export { __iconNode, IconRosetteDiscountCheck as default };
