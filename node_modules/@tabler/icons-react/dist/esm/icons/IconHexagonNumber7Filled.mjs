...
const IconHexagonNumber7Filled = createReactComponent("filled", "hexagon-number-7-filled", "HexagonNumber7Filled", __iconNode);

export { __iconNode, IconHexagonNumber7Filled as default };
