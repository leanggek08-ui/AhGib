...
const IconCircleDashedPlus = createReactComponent("outline", "circle-dashed-plus", "CircleDashedPlus", __iconNode);

export { __iconNode, IconCircleDashedPlus as default };
