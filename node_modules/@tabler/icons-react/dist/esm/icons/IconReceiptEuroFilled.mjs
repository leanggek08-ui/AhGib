...
const IconReceiptEuroFilled = createReactComponent("filled", "receipt-euro-filled", "ReceiptEuroFilled", __iconNode);

export { __iconNode, IconReceiptEuroFilled as default };
//# sourceMappingURL=IconReceiptEuroFilled.mjs.map
