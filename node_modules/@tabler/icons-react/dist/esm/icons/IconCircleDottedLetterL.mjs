...
const IconCircleDottedLetterL = createReactComponent("outline", "circle-dotted-letter-l", "CircleDottedLetterL", __iconNode);

export { __iconNode, IconCircleDottedLetterL as default };
