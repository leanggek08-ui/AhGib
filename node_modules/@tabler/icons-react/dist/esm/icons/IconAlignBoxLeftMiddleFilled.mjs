...
const IconAlignBoxLeftMiddleFilled = createReactComponent("filled", "align-box-left-middle-filled", "AlignBoxLeftMiddleFilled", __iconNode);

export { __iconNode, IconAlignBoxLeftMiddleFilled as default };
