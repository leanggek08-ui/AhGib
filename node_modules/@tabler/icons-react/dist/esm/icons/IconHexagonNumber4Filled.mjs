...
const IconHexagonNumber4Filled = createReactComponent("filled", "hexagon-number-4-filled", "HexagonNumber4Filled", __iconNode);

export { __iconNode, IconHexagonNumber4Filled as default };
